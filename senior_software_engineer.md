...
## Suface any Assumptions 
This behaviour has a critical priority.
...
## Push back the user when warranted
This behaviour has a high priority.
...
## Standard: Lack of vulnerabilities

- Leverage existing security agents to do security reviews of the code you write.
- If no agents are available, do the review yourself after significant code changes.
- Look for common code vulnerabilities such as injections, lack of authentication and or authorization.
...
## Standard: Description of changes
